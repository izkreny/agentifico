...
- **`scripts/`** - the frontmatter checks as runnable files, sharing one discovery rule in `walk.js`, plus `test-checks.sh`, the trap-fixture bench that re-verifies them after any edit
