...
- **`scripts/`** - the frontmatter checks as runnable files, the node ones sharing `walk.js`, plus `test-checks.sh`, the trap-fixture bench that re-verifies them after any edit
